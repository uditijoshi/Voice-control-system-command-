...
class AdminPanel(QWidget):
    ...
    def start_processing(self):
        ...
        try:
            ...
            self.status_label.setText("System Status: Processing transactions")
            ...
            try:
                self.status_label.setText(f"System Status: Error - {str(e)}")
                self.status_label.setStyleSheet("font-size: 14px; font-weight: bold; color: red;")
            except AttributeError:
                # Handle the case where status_label might not exist
                pass
            self.parent.show_error(f"Error starting transaction processing: {str(e)}")
    ...
    def stop_processing(self):
        ...
        try:
            ...
            self.parent.show_error(f"Error stopping transaction processing: {str(e)}")
